...
{
    public partial class UI_GraficasVentas : Form
    {
        public UI_GraficasVentas()
        {
            InitializeComponent();
        ...
        void CargarGraficaPrincipal()
        {
            ...
            sellMonth[5] = ExtraerValor(monthNumber[5], "tbl_ventasencabezado");
            sellMonth[6] = ExtraerValor(monthNumber[6], "tbl_ventasencabezado");
            sellMonth[7] = ExtraerValor(monthNumber[7], "tbl_ventasencabezado");
            sellMonth[8] = ExtraerValor(monthNumber[8], "tbl_ventasencabezado");
            sellMonth[9] = ExtraerValor(monthNumber[9], "tbl_ventasencabezado");

            double mesActual = 0;
            double mesAnterior = 0;

            mesActual = ExtraerValor(monthNumber[9] + "' AND Cancelado = '1", "tbl_ventasencabezado");
            mesAnterior = ExtraerValor(monthNumber[0] + "' AND Cancelado = '1", "tbl_ventasencabezado");
        ...
        void CargarGraficaDonut()
        {
            ...
            monthCant[0] = ExtraerValor(monthNumber, "tbl_ventasencabezado");
            monthCant[1] = ExtraerValor(monthNumber + "' AND Cancelado = '1", "tbl_ventasencabezado");
