...
namespace MantenimientoProductos
{
    public partial class UI_OtrasConfiguraciones : Form
    {
        ...
        void LoadForm()
        {
            ...
            try
            {
                DataSet ds = cpd.LlenarGrid(cadenaDeCampos, tabla, sWhere, "Vista de datos de " + comboBoxTipoDato.Text);
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    cpd.ModificarDatos(tabla, "status = 0", "id", codigoACambiar , "Actualizacion de datos en " + comboBoxTipoDato.Text);
